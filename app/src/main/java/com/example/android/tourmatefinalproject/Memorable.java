...
public class Memorable extends AppCompatActivity implements View.OnClickListener{
    ...
    private Button buttonShow,uploadButton;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageView=(ImageView)findViewById(R.id.imageView);
        buttonShow = (Button) findViewById(R.id.showBT);
        firebaseAuth=FirebaseAuth.getInstance();
        storageReference = FirebaseStorage.getInstance().getReference();
        mDatabase= FirebaseDatabase.getInstance().getReference().child("Users").child(firebaseAuth.getUid()).child("Memory");
